...
.withColumn("day_of_year", dayofyear(current_timestamp()))
display(dataFrame2)
...
// MAGIC %sql
// MAGIC SELECT to_unix_timestamp('2022-03-14', 'yyyy-MM-dd');

// COMMAND ----------

// MAGIC %sql
// MAGIC SELECT from_unixtime(unix_timestamp(),'yyy-MM-dd hh:mm:ss');

// COMMAND ----------

// MAGIC %sql
// MAGIC Select to_date('14-03-2022','dd-MM-yyyy')

// COMMAND ----------

// MAGIC %sql
// MAGIC select to_timestamp('14-03-2022 12:34:56', 'dd-MM-yyy hh:mm:ss')

// COMMAND ----------

// MAGIC %sql
// MAGIC select from_utc_timestamp('2022-03-14 12:34:56', 'GMT+1')

// COMMAND ----------

// MAGIC %sql
// MAGIC select to_utc_timestamp('2022-03-14 12:34:56', 'GMT+1')