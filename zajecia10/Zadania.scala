...
val df = spark.read.format("csv")
              ...
              .load("dbfs:/FileStore/tables/online_retail_dataset.csv")
...
par.write.format("delta").partitionBy("Country").mode("overwrite").save("dbfs:/FileStore/tables/delta_retail")
...
spark.sql(s"""
  ...
  USING Delta
  LOCATION 'dbfs:/FileStore/tables/delta_retail'
""")
